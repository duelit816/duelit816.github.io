...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-reset-password-reset-password-module"], {
  ...
  /***/
  function srcAppCorePagesResetPasswordResetPasswordRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _valid_token_resolver__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    ...
    ResetPasswordRoutingModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
      type: ResetPasswordRoutingModule
    });
    ResetPasswordRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](ResetPasswordRoutingModule, {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ResetPasswordRoutingModule, [{
  ...
  /***/
  function srcAppCorePagesResetPasswordResetPasswordComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _shared_functions_timer_function__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    ...
    function ResetPasswordComponent_ng_container_0_ng_container_8_span_1_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function ResetPasswordComponent_ng_container_0_ng_container_8_span_2_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span", 11);
    ...
    function ResetPasswordComponent_ng_container_0_ng_container_8_span_3_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span", 11);
    ...
    function ResetPasswordComponent_ng_container_0_ng_container_8_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function ResetPasswordComponent_ng_container_0_ng_container_10_span_1_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span", 11);
    ...
    function ResetPasswordComponent_ng_container_0_ng_container_10_span_2_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span", 11);
    ...
    function ResetPasswordComponent_ng_container_0_ng_container_10_span_3_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span", 11);
    ...
    function ResetPasswordComponent_ng_container_0_ng_container_10_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](0);
    ...
    function ResetPasswordComponent_ng_container_0_span_12_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "span", 12);
      }
    }

    function ResetPasswordComponent_ng_container_0_ng_template_13_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](0, "Send Request");
      }
    }

    function ResetPasswordComponent_ng_container_0_span_15_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span", 11);
    ...
    function ResetPasswordComponent_ng_container_0_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ResetPasswordComponent_ng_container_0_Template_button_click_11_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r47);

          var ctx_r46 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r46.resetPassword();
        });
      ...
      if (rf & 2) {
        var _r37 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](14);
    ...
    function ResetPasswordComponent_ng_template_1_ng_container_1_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](0);
    ...
    function ResetPasswordComponent_ng_template_1_ng_template_2_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function ResetPasswordComponent_ng_template_1_Template(rf, ctx) {
      if (rf & 1) {
    ...
    /*#__PURE__*/
    function () {
      function ResetPasswordComponent(router, route, toast, fb, api) {
      ...
      _createClass(ResetPasswordComponent, [{
        ...
        value: function ngOnInit() {
          ...
          if (!this.valid) {
            ...
            Object(_shared_functions_timer_function__WEBPACK_IMPORTED_MODULE_3__["countDown"])(this.countdown).subscribe(function (t) {
              _this.timer$.next(t);
        ...
        value: function resetPassword() {
          ...
          if (this.isPasswordSame()) {
            this.api.post(_shared_constants_api__WEBPACK_IMPORTED_MODULE_2__["UsersApi"].ResetPassword, {
              ...
              _this2.isResettingPassword = false;

              if (result === 'successful') {
                _this2.toast.success('Reset password successful');

                _this2.resetPasswordFinished = true;
                Object(_shared_functions_timer_function__WEBPACK_IMPORTED_MODULE_3__["countDown"])(_this2.countdown).subscribe(function (t) {
                  _this2.timer$.next(t);
                ...
                _this2.toast.error(result.error.text || JSON.stringify(result.error));
              }
            });
          } else {
        ...
        key: "isPasswordSame",
        value: function isPasswordSame() {
          var passwordControl = this.resetPasswordForm.get('password');
          var confirmControl = this.resetPasswordForm.get('confirm');
          return confirmControl.value === passwordControl.value;
        }
      }, {
        key: "isControlsTouched",
        value: function isControlsTouched() {
          var passwordControl = this.resetPasswordForm.get('password');
          var confirmControl = this.resetPasswordForm.get('confirm');
    ...
    ResetPasswordComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      selectors: [["duelit-reset-password"]],
      decls: 3,
      vars: 2,
      consts: [[4, "ngIf", "ngIfElse"], ["invalid", ""], [1, "form-group", 3, "formGroup"], ["type", "password", "placeholder", "New password", "autocomplete", "off", "formControlName", "password", 1, "form-control", "custom"], [4, "ngIf"], ["type", "password", "placeholder", "Repeat new password", "autocomplete", "off", "formControlName", "confirm", 1, "form-control", "custom"], [1, "btn", "custom", "primary", 3, "disabled", "click"], ["class", "loading", 4, "ngIf", "ngIfElse"], ["reset", ""], ["class", "error", 4, "ngIf"], [3, "routerLink"], [1, "error"], [1, "loading"], [1, "invalid-msg"], ["invalidLink", ""], [1, "link", 3, "routerLink"]],
  ...
  /***/
  function srcAppCorePagesResetPasswordResetPasswordModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    ResetPasswordModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      ...
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_0__["CommonModule"], _reset_password_routing_module__WEBPACK_IMPORTED_MODULE_4__["ResetPasswordRoutingModule"], _shared_components_panel__WEBPACK_IMPORTED_MODULE_3__["PanelModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["ReactiveFormsModule"]]]
    });
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](ResetPasswordModule, [{
  ...
  /***/
  function srcAppCorePagesResetPasswordValidTokenResolverTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ValidateTokenResolver", function () {
      return ValidateTokenResolver;
    });
    /* harmony import */
    ...
    var ValidateTokenResolver =
    /*#__PURE__*/
    function () {
      function ValidateTokenResolver(api) {
        _classCallCheck(this, ValidateTokenResolver);

        this.api = api;
      }

      _createClass(ValidateTokenResolver, [{
        key: "resolve",
        value: function resolve(route, state) {
          var path = this.api.buildPath(_shared_constants_api__WEBPACK_IMPORTED_MODULE_1__["UsersApi"].ValidateToken, {
            token: route.paramMap.get('token')
          });
          return this.api.get(path).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (err) {
            if (err.status === 200) {
    ...
    ValidateTokenResolver.ɵfac = function ValidateTokenResolver_Factory(t) {
      return new (t || ValidateTokenResolver)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_core_services_api_service__WEBPACK_IMPORTED_MODULE_4__["ApiService"]));
    };

    ValidateTokenResolver.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
      token: ValidateTokenResolver,
      factory: ValidateTokenResolver.ɵfac,
      providedIn: 'root'
    });
    /*@__PURE__*/

    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ValidateTokenResolver, [{
