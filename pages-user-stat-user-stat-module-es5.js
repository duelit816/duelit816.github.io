...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-user-stat-user-stat-module"], {
  ...
  /***/
  function srcAppFeaturesAdminPagesUserStatUserStatRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "UserStatRoutingModule", function () {
      return UserStatRoutingModule;
    });
    /* harmony import */
    ...
    var _user_stat_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./user-stat.component */
    "./src/app/features/admin/pages/user-stat/user-stat.component.ts");

    var routes = [{
      path: '',
      component: _user_stat_component__WEBPACK_IMPORTED_MODULE_2__["UserStatComponent"]
    }];

    var UserStatRoutingModule = function UserStatRoutingModule() {
      _classCallCheck(this, UserStatRoutingModule);
    };

    UserStatRoutingModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
      type: UserStatRoutingModule
    });
    UserStatRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      factory: function UserStatRoutingModule_Factory(t) {
        return new (t || UserStatRoutingModule)();
      },
      imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild(routes)], _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](UserStatRoutingModule, {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](UserStatRoutingModule, [{
  ...
  /***/
  function srcAppFeaturesAdminPagesUserStatUserStatComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "UserStatComponent", function () {
      return UserStatComponent;
    });
    /* harmony import */
    ...
    var _core_services_api_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    ...
    var _components_metric_metric_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ../../components/metric/metric.component */
    "./src/app/features/admin/components/metric/metric.component.ts");
    /* harmony import */


    var _components_keen_api_keen_api_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ../../components/keen-api/keen-api.component */
    "./src/app/features/admin/components/keen-api/keen-api.component.ts");

    function UserStatComponent_ng_container_0_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function UserStatComponent_ng_template_2_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var UserStatComponent =
    /*#__PURE__*/
    function () {
      function UserStatComponent(api, route, toast, numberPipe) {
        _classCallCheck(this, UserStatComponent);
      ...
      _createClass(UserStatComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          var _this = this;

          var userId = this.route.snapshot.params.userId;
          var userStatsPath = this.api.buildPath(_shared_constants_api__WEBPACK_IMPORTED_MODULE_1__["UsersApi"].UserStats, [userId]);
          this.stats$ = this.api.get(userStatsPath).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (err) {
        ...
        key: "getMetric",
        value: function getMetric(title, subTitle, data) {
          return {
            title: title,
            subTitle: subTitle,
            data: data
        ...
        key: "getCoinDollarMetric",
        value: function getCoinDollarMetric(title, subTitle, coins, dollar) {
          var isAverage = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : false;
          var dollarFormat = isAverage ? '.3-3' : '0.0';
          var data = "$".concat(this.numberPipe.transform(dollar, dollarFormat), "<br>").concat(this.numberPipe.transform(coins, '.2-2'), " coins");
          return this.getMetric(title, subTitle, data);
        }
      }, {
        key: "getChallengeStats",
        value: function getChallengeStats() {
          var _this2 = this;

          this.stats$.subscribe(function (userStats) {
            var createdChallengeVsHours = userStats["createdChallengeVsHours"];
            var createdData = [];
            ...
            if (createdChallengeVsHours) {
              for (var i = 0; i < 24; i++) {
                createdData.push({
                  type: i,
                  count: createdChallengeVsHours[i] || 0
                });
              }
            }

            _this2.createdChallengeStats$.data = createdData;
            var playedChallengeVsHours = userStats["playedChallengeVsHours"];
            var playedData = [];
            ...
            if (playedChallengeVsHours) {
              for (var _i = 0; _i < 24; _i++) {
                playedData.push({
                  type: _i,
                  count: playedChallengeVsHours[_i] || 0
                });
              }
            }

            _this2.playedChallengeStats$.data = playedData;
          });
        }
      }]);
    ...
    UserStatComponent.ɵfac = function UserStatComponent_Factory(t) {
      return new (t || UserStatComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_core_services_api_service__WEBPACK_IMPORTED_MODULE_4__["ApiService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_5__["ActivatedRoute"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_core_services_toast_service__WEBPACK_IMPORTED_MODULE_6__["ToastService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_common__WEBPACK_IMPORTED_MODULE_7__["DecimalPipe"]));
    };

    UserStatComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: UserStatComponent,
      selectors: [["duelit-user-stat"]],
      decls: 4,
      vars: 4,
      consts: [[4, "ngIf", "ngIfElse"], ["loading", ""], ["onclick", "window.history.back()", 1, "pointer"], [1, "row", "container"], [1, "col-3", 3, "metric"], [1, "col-12", 3, "keenApiInput"], [1, "col-4", 3, "metric"], [1, "col-4", "coin-dollar-metric", 3, "metric"], [1, "col", "col-loading"], [1, "metric", "loading"]],
      template: function UserStatComponent_Template(rf, ctx) {
        if (rf & 1) {
        ...
        if (rf & 2) {
          var _r195 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](3);
  ...
  /***/
  function srcAppFeaturesAdminPagesUserStatUserStatModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "UserStatModule", function () {
      return UserStatModule;
    });
    /* harmony import */
    ...
    var _components_metric_metric_module__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../../components/metric/metric.module */
    "./src/app/features/admin/components/metric/metric.module.ts");
    /* harmony import */


    var _user_stat_routing_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./user-stat-routing.module */
    "./src/app/features/admin/pages/user-stat/user-stat-routing.module.ts");
    /* harmony import */


    var _components_keen_api_keen_api_module__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ../../components/keen-api/keen-api.module */
    "./src/app/features/admin/components/keen-api/keen-api.module.ts");
    /* harmony import */


    var _user_stat_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./user-stat.component */
    "./src/app/features/admin/pages/user-stat/user-stat.component.ts");

    var UserStatModule = function UserStatModule() {
      _classCallCheck(this, UserStatModule);
    };

    UserStatModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineNgModule"]({
      type: UserStatModule
    });
    UserStatModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      factory: function UserStatModule_Factory(t) {
        return new (t || UserStatModule)();
      },
      providers: [_angular_common__WEBPACK_IMPORTED_MODULE_0__["DecimalPipe"]],
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_0__["CommonModule"], _user_stat_routing_module__WEBPACK_IMPORTED_MODULE_3__["UserStatRoutingModule"], _components_metric_metric_module__WEBPACK_IMPORTED_MODULE_2__["MetricModule"], _components_keen_api_keen_api_module__WEBPACK_IMPORTED_MODULE_4__["KeenApiModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](UserStatModule, {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](UserStatModule, [{
...
//# sourceMappingURL=pages-user-stat-user-stat-module-es5.js.map