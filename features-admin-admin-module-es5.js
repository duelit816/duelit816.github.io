...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["features-admin-admin-module"], {
  /***/
  "./node_modules/keen-analysis/dist/keen-analysis.js":
  /*!**********************************************************!*\
    !*** ./node_modules/keen-analysis/dist/keen-analysis.js ***!
    \**********************************************************/
  ...
  /***/
  function node_modulesKeenAnalysisDistKeenAnalysisJs(module, exports, __webpack_require__) {
    (function webpackUniversalModuleDefinition(root, factory) {
      ...
      return (
        ...
        function (module, __webpack_exports__, __webpack_require__) {
          ...
          (function (global) {
            /* harmony import */
            var _index__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(9);
            /* harmony import */


            var _finally__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(4);
            ...
            if (!globalNS.Promise) {
              globalNS.Promise = _index__WEBPACK_IMPORTED_MODULE_0__[
              /* default */
              "a"];
            } else if (!globalNS.Promise.prototype['finally']) {
              globalNS.Promise.prototype['finally'] = _finally__WEBPACK_IMPORTED_MODULE_1__[
              /* default */
              "a"];
            }
            /* WEBPACK VAR INJECTION */
        ...
        function (module) {
          module.exports = {
            ...
            "contributors": ["Dustin Larimer <dustin@keen.io> (https://github.com/dustinlarimer)", "Adam Kasprowicz <adam.kasprowicz@keen.io> (https://github.com/adamkasprowicz)", "Dariusz Łacheta <dariusz.lacheta@keen.io> (https://github.com/dariuszlacheta)"],
            "keywords": ["Analytics", "Analysis", "Conversion", "Query", "Stats", "Client", "Min", "Max", "Count", "Percentile", "Average", "Median", "Keen", "Keen Query"],
            "license": "MIT",
            "bugs": {
        ...
        function (module, __webpack_exports__, __webpack_require__) {
          ...
          (function (setImmediate) {
            /* harmony import */
            var _finally__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4); // Store setTimeout reference so promise-polyfill will be unaffected by
            ...
            Promise.prototype['finally'] = _finally__WEBPACK_IMPORTED_MODULE_0__[
            /* default */
            "a"];
          ...
          function initializeIndexedDb() {
            ...
            return new Promise(function (resolve, reject) {
              ...
              dbConnectionRequest.onupgradeneeded = function (event) {
                ...
                var objectStore = db.createObjectStore(cacheConfig.dbCollectionName, {
                  keyPath: cacheConfig.dbCollectionKey
                });
                objectStore.createIndex(cacheConfig.dbCollectionKey, cacheConfig.dbCollectionKey, {
                  unique: true
                });
                objectStore.createIndex('expiryTime', 'expiryTime', {
                  unique: false
                });
              };
          ...
          var sendFetch = function sendFetch(method, config) {
            ...
            if (config.cache && method !== 'DELETE' && method !== 'PUT' && !options.notFoundInCache) {
              return (0, _cacheBrowser.getFromCache)(url, fetchOptions, config).then(function (responseJSONFromCache) {
                ...
                sendFetch(method, config, _extends({}, options, {
            ...
            fetch(url, _extends({}, fetchOptions, {
              ...
              if (httpOptions.params && typeof httpOptions.params.event_collection !== 'undefined' && typeof responseJSON.query === 'undefined') {
                var responseWithQuery = (0, _extend2.default)({
                  query: httpOptions.params
                }, responseJSON);
        ...
        function (module, exports, __webpack_require__) {
                ...
                paramKeys.forEach(function (key) {
                  if (requestUrlAndOptions[key]) {
                    ...
                    if (Array.isArray(urlParam)) {
                      urlParam = (0, _keysToUnderscore.mapKeysToUnderscore)({
                        vals: urlParam
                      }).vals;
          ...
          request.prototype.send = function (obj) {
            ...
            var self = this; // Temporary mod to append analysis_type to responses
          ...
          (function (global) {
            (function (env) {
              ...
              function Client(props) {
                ...
                this.configure(props); // Set up event handling
              ...
              Client.helpers = Client.helpers || {}; // Set or extend resources
        ...
        function (module, exports, __webpack_require__) {
          ...
          }).call(this, __webpack_require__(2), __webpack_require__(19));
          /***/
        },
        /* 21 */
        ...
        function (module, exports, __webpack_require__) {
          ...
          (function (global) {
            ...
            __webpack_require__(20); // On some exotic environments, it's not clear which object `setimmediate` was
        ...
        function (module, exports, __webpack_require__) {
          ...
          _keenCore2.default.prototype.query = function (a) {
            ...
            var options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
            (0, _validateAuthCredentials.validateAuthCredentials)(this.config); // a - analysis type or config object
            // b - params
            ...
            var queryParams = mapObj.b; // all this for backward compatibility, remove in next major version
            ...
            options.resultParsers = this.config.resultParsers; // for deprecated queries
              ...
              return this.get({
                ...
                return this.get({
                  ...
                  return this.get({
                    ...
                    var queryBodyParams = (0, _extend2.default)({
                      analysis_type: analysisType
                    }, queryParams); // Localize timezone if none is set
          ...
          _keenCore2.default.prototype.run = function (q, callback) {
            ...
            (0, _each2.default)(queries, function (query, i) {
              ...
              if (typeof query === 'string') {
                ...
                // Include analysis_type for downstream use
                queryPromise = self.query(query.analysis, (0, _extend2.default)({
                  analysis_type: query.analysis
  ...
  function srcAppFeaturesAdminAdminRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var routes = [{
      ...
      loadChildren: function loadChildren() {
        ...
        [__webpack_require__.e("default~pages-dashboard-dashboard-module~pages-profile-profile-module~pages-tournaments-tournaments-~832c71b2"), __webpack_require__.e("default~pages-dashboard-dashboard-module~pages-profile-profile-module~pages-user-create-user-create-~48c46546"), __webpack_require__.e("default~pages-dashboard-dashboard-module~pages-user-stat-user-stat-module"), __webpack_require__.e("default~pages-dashboard-dashboard-module~pages-users-users-module"), __webpack_require__.e("pages-dashboard-dashboard-module")]).then(__webpack_require__.bind(null,
        /*! ./pages/dashboard/dashboard.module */
        "./src/app/features/admin/pages/dashboard/dashboard.module.ts")).then(function (m) {
      ...
      loadChildren: function loadChildren() {
        return Promise.all(
        /*! import() | pages-user-stat-user-stat-module */
        [__webpack_require__.e("default~pages-dashboard-dashboard-module~pages-user-stat-user-stat-module"), __webpack_require__.e("pages-user-stat-user-stat-module")]).then(__webpack_require__.bind(null,
        /*! ./pages/user-stat/user-stat.module */
        "./src/app/features/admin/pages/user-stat/user-stat.module.ts")).then(function (m) {
          return m.UserStatModule;
        });
      },
      canActivate: [_guards_admin_guard__WEBPACK_IMPORTED_MODULE_2__["AdminGuard"]]
    }, {
      ...
      loadChildren: function loadChildren() {
        return Promise.all(
        /*! import() | pages-user-edit-user-edit-module */
        [__webpack_require__.e("default~pages-dashboard-dashboard-module~pages-profile-profile-module~pages-tournaments-tournaments-~832c71b2"), __webpack_require__.e("default~pages-dashboard-dashboard-module~pages-profile-profile-module~pages-user-create-user-create-~48c46546"), __webpack_require__.e("default~pages-countries-countries-module~pages-user-edit-user-edit-module~pages-users-users-module"), __webpack_require__.e("pages-user-edit-user-edit-module")]).then(__webpack_require__.bind(null,
        /*! ./pages/user-edit/user-edit.module */
        "./src/app/features/admin/pages/user-edit/user-edit.module.ts")).then(function (m) {
          return m.UserEditModule;
        });
      },
      canActivate: [_guards_admin_guard__WEBPACK_IMPORTED_MODULE_2__["AdminGuard"]]
    }, {
      ...
      loadChildren: function loadChildren() {
        return Promise.all(
        /*! import() | pages-user-create-user-create-module */
        [__webpack_require__.e("default~pages-dashboard-dashboard-module~pages-profile-profile-module~pages-tournaments-tournaments-~832c71b2"), __webpack_require__.e("default~pages-dashboard-dashboard-module~pages-profile-profile-module~pages-user-create-user-create-~48c46546"), __webpack_require__.e("common"), __webpack_require__.e("pages-user-create-user-create-module")]).then(__webpack_require__.bind(null,
        /*! ./pages/user-create/user-create.module */
        "./src/app/features/admin/pages/user-create/user-create.module.ts")).then(function (m) {
          return m.UserCreateModule;
        });
      },
      canActivate: [_guards_admin_guard__WEBPACK_IMPORTED_MODULE_2__["AdminGuard"]]
    }, {
      ...
      loadChildren: function loadChildren() {
        ...
        [__webpack_require__.e("default~pages-dashboard-dashboard-module~pages-profile-profile-module~pages-tournaments-tournaments-~832c71b2"), __webpack_require__.e("default~pages-dashboard-dashboard-module~pages-profile-profile-module~pages-user-create-user-create-~48c46546"), __webpack_require__.e("default~pages-countries-countries-module~pages-user-edit-user-edit-module~pages-users-users-module"), __webpack_require__.e("default~pages-countries-countries-module~pages-users-users-module"), __webpack_require__.e("default~pages-dashboard-dashboard-module~pages-users-users-module"), __webpack_require__.e("pages-users-users-module")]).then(__webpack_require__.bind(null,
        /*! ./pages/users/users.module */
        "./src/app/features/admin/pages/users/users.module.ts")).then(function (m) {
      ...
      loadChildren: function loadChildren() {
        return Promise.all(
        /*! import() | pages-tournaments-tournaments-module */
        [__webpack_require__.e("default~pages-dashboard-dashboard-module~pages-profile-profile-module~pages-tournaments-tournaments-~832c71b2"), __webpack_require__.e("pages-tournaments-tournaments-module")]).then(__webpack_require__.bind(null,
        /*! ./pages/tournaments/tournaments.module */
        "./src/app/features/admin/pages/tournaments/tournaments.module.ts")).then(function (m) {
      ...
      loadChildren: function loadChildren() {
        return Promise.all(
        /*! import() | pages-countries-countries-module */
        [__webpack_require__.e("default~pages-countries-countries-module~pages-user-edit-user-edit-module~pages-users-users-module"), __webpack_require__.e("default~pages-countries-countries-module~pages-users-users-module"), __webpack_require__.e("pages-countries-countries-module")]).then(__webpack_require__.bind(null,
        /*! ./pages/countries/countries.module */
        "./src/app/features/admin/pages/countries/countries.module.ts")).then(function (m) {
          return m.CountriesModule;
        });
      },
      canActivate: [_guards_admin_guard__WEBPACK_IMPORTED_MODULE_2__["AdminGuard"]]
    }, {
      ...
      loadChildren: function loadChildren() {
        ...
        [__webpack_require__.e("default~pages-dashboard-dashboard-module~pages-profile-profile-module~pages-tournaments-tournaments-~832c71b2"), __webpack_require__.e("default~pages-dashboard-dashboard-module~pages-profile-profile-module~pages-user-create-user-create-~48c46546"), __webpack_require__.e("pages-profile-profile-module")]).then(__webpack_require__.bind(null,
        /*! ./pages/profile/profile.module */
        "./src/app/features/admin/pages/profile/profile.module.ts")).then(function (m) {
      ...
      loadChildren: function loadChildren() {
        ...
        /*! import() | pages-app-control-app-control-module */
        "pages-app-control-app-control-module").then(__webpack_require__.bind(null,
        /*! ./pages/app-control/app-control.module */
        "./src/app/features/admin/pages/app-control/app-control.module.ts")).then(function (m) {
          return m.AppControlModule;
        });
      }
    }, {
      path: '**',
  ...
  /***/
  function srcAppFeaturesAdminAdminComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    AdminComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      styles: ["\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2ZlYXR1cmVzL2FkbWluL2FkbWluLmNvbXBvbmVudC5zY3NzIn0= */"]
    });
    /*@__PURE__*/
  ...
  function srcAppFeaturesAdminAdminModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _services_dashboard_date_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./services/dashboard-date.service */
    "./src/app/features/admin/services/dashboard-date.service.ts");
    /* harmony import */


    var _services_users_date_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./services/users-date.service */
    "./src/app/features/admin/services/users-date.service.ts");
    /* harmony import */


    var _services_keen_io_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    ...
    AdminModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      ...
      providers: [_services_dashboard_date_service__WEBPACK_IMPORTED_MODULE_4__["DashboardDateService"], _services_keen_io_service__WEBPACK_IMPORTED_MODULE_6__["KeenIoService"], _services_users_date_service__WEBPACK_IMPORTED_MODULE_5__["UsersDateService"]],
  ...
  /*! exports provided: DashboardDateService */

  /***/
  function srcAppFeaturesAdminServicesDashboardDateServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "DashboardDateService", function () {
      return DashboardDateService;
    });
    /* harmony import */
    ...
    var DashboardDateService = function DashboardDateService(calendar) {
      _classCallCheck(this, DashboardDateService);

      var today = calendar.getToday();
      this.range = {
        from: calendar.getPrev(today, 'd', 6),
        to: today
      };
    };

    DashboardDateService.ɵfac = function DashboardDateService_Factory(t) {
      return new (t || DashboardDateService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_1__["NgbCalendar"]));
    };

    DashboardDateService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
      token: DashboardDateService,
      factory: DashboardDateService.ɵfac
    });
    /*@__PURE__*/

    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](DashboardDateService, [{
  ...
  /*! exports provided: KeenIoService */

  /***/
  function srcAppFeaturesAdminServicesKeenIoServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "KeenIoService", function () {
      return KeenIoService;
    });
    /* harmony import */
    ...
    var keen_analysis__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! keen-analysis */
    "./node_modules/keen-analysis/dist/keen-analysis.js");
    /* harmony import */


    var keen_analysis__WEBPACK_IMPORTED_MODULE_1___default =
    /*#__PURE__*/
    __webpack_require__.n(keen_analysis__WEBPACK_IMPORTED_MODULE_1__);
    /* harmony import */
    ...
    /*#__PURE__*/
    function () {
      function KeenIoService(http) {
        _classCallCheck(this, KeenIoService);

        this.http = http;
        this.keen = new keen_analysis__WEBPACK_IMPORTED_MODULE_1__["Keen"](src_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].keenio);
      }

      _createClass(KeenIoService, [{
        key: "run",
        value: function run() {
          var _this$keen;

          return (_this$keen = this.keen).run.apply(_this$keen, arguments);
        }
      }, {
        key: "oldquery",
        value: function oldquery() {
          var _this$keen2;

          return (_this$keen2 = this.keen).query.apply(_this$keen2, arguments);
        }
      }, {
        key: "query",
        value: function query(analysisType, _query) {
          var KeenAuthHeader = new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpHeaders"]({
            Authorization: src_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].keenio.readKey
          });
          var keenQuery = this.transformQuery(analysisType, _query);
          return this.http.post("https://api.keen.io/3.0/projects/".concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].keenio.projectId, "/queries/").concat(analysisType), keenQuery, {
            headers: KeenAuthHeader
        ...
        key: "transformQuery",
        value: function transformQuery(analysisType, query) {
          var keenIoQuery = Object.assign({}, query);
          keenIoQuery.analysis_type = analysisType;
          keenIoQuery.timezone = 'UTC';
          keenIoQuery.event_collection = query.eventCollection;
          delete keenIoQuery.eventCollection;

          if (query.groupBy) {
            keenIoQuery.group_by = query.groupBy;
            delete keenIoQuery.groupBy;
          }
    ...
    KeenIoService.ɵfac = function KeenIoService_Factory(t) {
      return new (t || KeenIoService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"]));
    };

    KeenIoService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
      token: KeenIoService,
      factory: KeenIoService.ɵfac
    });
    /*@__PURE__*/

    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](KeenIoService, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"]
      }], function () {
        return [{
  ...
  /*! exports provided: UsersDateService */

  /***/
  function srcAppFeaturesAdminServicesUsersDateServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "UsersDateService", function () {
      return UsersDateService;
    });
    /* harmony import */
    ...
    var UsersDateService = function UsersDateService(calendar) {
      _classCallCheck(this, UsersDateService);

      var today = calendar.getToday();
      this.range = {
        from: new _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_1__["NgbDate"](2016, 1, 1),
        to: today
      };
    };

    UsersDateService.ɵfac = function UsersDateService_Factory(t) {
      return new (t || UsersDateService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_1__["NgbCalendar"]));
    };

    UsersDateService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
      token: UsersDateService,
      factory: UsersDateService.ɵfac
    });
    /*@__PURE__*/

    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](UsersDateService, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"]
      }], function () {
        return [{
          type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_1__["NgbCalendar"]
