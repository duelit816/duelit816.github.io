...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-countries-countries-module"], {
  ...
  /***/
  function srcAppFeaturesAdminPagesCountriesCountriesRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "CountriesRoutingModule", function () {
    ...
    var _countries_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./countries.component */
    ...
    var CountriesRoutingModule = function CountriesRoutingModule() {
      _classCallCheck(this, CountriesRoutingModule);
    };

    CountriesRoutingModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
      type: CountriesRoutingModule
    });
    CountriesRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      factory: function CountriesRoutingModule_Factory(t) {
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](CountriesRoutingModule, {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](CountriesRoutingModule, [{
  ...
  /***/
  function srcAppFeaturesAdminPagesCountriesCountriesComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    function CountriesComponent_ng_container_0_th_3_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function CountriesComponent_ng_container_0_td_4_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function CountriesComponent_ng_container_0_th_6_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "th", 18);
    ...
    function CountriesComponent_ng_container_0_td_7_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "td", 19);
    ...
    function CountriesComponent_ng_container_0_th_9_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function CountriesComponent_ng_container_0_td_10_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function CountriesComponent_ng_container_0_td_10_Template_input_change_2_listener($event) {
          ...
          return ctx_r355.updateCountry("fortrivia", $event.target.checked, element_r354, $event.target);
        });
    ...
    function CountriesComponent_ng_container_0_th_12_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "th", 20);
    ...
    function CountriesComponent_ng_container_0_td_13_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function CountriesComponent_ng_container_0_td_13_Template_input_change_2_listener($event) {
          ...
          return ctx_r358.updateCountry("allowed", $event.target.checked, element_r357, $event.target);
        });
    ...
    function CountriesComponent_ng_container_0_th_15_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function CountriesComponent_ng_container_0_th_17_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "th", 24);
    ...
    function CountriesComponent_ng_container_0_th_19_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "th", 24);
    ...
    function CountriesComponent_ng_container_0_th_21_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "th", 24);
    ...
    function CountriesComponent_ng_container_0_tr_22_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "tr", 27);
      }
    }

    function CountriesComponent_ng_container_0_tr_23_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "tr", 28);
      }
    }

    function CountriesComponent_ng_container_0_tr_24_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var _c0 = function _c0() {
      return ["code-search", "name-search", "fortrivia-search", "allowed-search"];
    };

    function CountriesComponent_ng_container_0_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("matSortChange", function CountriesComponent_ng_container_0_Template_table_matSortChange_1_listener($event) {
          ...
          return ctx_r361.sortData($event);
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("pageChange", function CountriesComponent_ng_container_0_Template_ngb_pagination_pageChange_25_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r362);

          var ctx_r363 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r363.onPageChange($event);
        });
      ...
      if (rf & 2) {
        var countriesPaginated_r336 = ctx.$implicit;
    ...
    /*#__PURE__*/
    function () {
      function CountriesComponent(api, fb, toast) {
      ...
      _createClass(CountriesComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.countriesPaginated$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["combineLatest"])([this.page$, this.sortDirection$, this.filterFormGroup.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["startWith"])(this.filterFormGroup.value))]).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function () {
            return _this.isLoading = true;
          }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["distinctUntilChanged"])(), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["debounceTime"])(500), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(function (_ref) {
            ...
            var path = _this.api.buildPath(_shared_constants_api__WEBPACK_IMPORTED_MODULE_2__["CountriesApi"].CountriesPaginated, {
              page: (page - 1) * limit,
              limit: limit,
              order: sortDirection.active
            });

            return _this.api.get(path, {
              query: {
        ...
        key: "updateCountry",
        value: function updateCountry(column, value, country, input) {
          var _this2 = this;
          ...
          this.api.put(_shared_constants_api__WEBPACK_IMPORTED_MODULE_2__["CountriesApi"].UpdateCountry, {
            ...
            _this2.toast.success("Successfully updated ".concat(country.name, ". Updated ").concat(column === 'allowed' ? 'Allowed' : 'For Trivia', " to ").concat(value));
          });
        }
      }]);
    ...
    CountriesComponent.ɵfac = function CountriesComponent_Factory(t) {
      return new (t || CountriesComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_core_services_api_service__WEBPACK_IMPORTED_MODULE_5__["ApiService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_core_services_toast_service__WEBPACK_IMPORTED_MODULE_6__["ToastService"]));
    };

    CountriesComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: CountriesComponent,
      selectors: [["duelit-countries"]],
      decls: 2,
      vars: 3,
      consts: [[4, "ngIf"], ["mat-table", "", "matSort", "", 1, "mat-elevation-z8", 3, "dataSource", "formGroup", "matSortChange"], ["matColumnDef", "code"], ["mat-header-cell", "", "mat-sort-header", "", 4, "matHeaderCellDef"], ["mat-cell", "", 4, "matCellDef"], ["matColumnDef", "name"], ["matColumnDef", "fortrivia"], ["mat-header-cell", "", 4, "matHeaderCellDef"], ["matColumnDef", "allowed"], ["matColumnDef", "code-search"], ["mat-header-cell", "", "class", "form-group", 4, "matHeaderCellDef"], ["matColumnDef", "name-search"], ["matColumnDef", "fortrivia-search"], ["matColumnDef", "allowed-search"], ["mat-header-row", "", "class", "named-columns", 4, "matHeaderRowDef", "matHeaderRowDefSticky"], ["mat-header-row", "", 4, "matHeaderRowDef", "matHeaderRowDefSticky"], ["mat-row", "", 4, "matRowDef", "matRowDefColumns"], [1, "d-flex", "justify-content-center", 3, "collectionSize", "pageSize", "page", "maxSize", "rotate", "pageChange"], ["mat-header-cell", "", "mat-sort-header", ""], ["mat-cell", ""], ["mat-header-cell", ""], [1, "switch"], ["type", "checkbox", 3, "change"], [1, "slider", "round"], ["mat-header-cell", "", 1, "form-group"], ["type", "text", "formControlName", "code", 1, "form-control"], ["type", "text", "formControlName", "name", 1, "form-control"], ["mat-header-row", "", 1, "named-columns"], ["mat-header-row", ""], ["mat-row", ""]],
  ...
  /***/
  function srcAppFeaturesAdminPagesCountriesCountriesModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "CountriesModule", function () {
    ...
    var _countries_routing_module__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./countries-routing.module */
    "./src/app/features/admin/pages/countries/countries-routing.module.ts");
    /* harmony import */


    var _countries_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./countries.component */
    "./src/app/features/admin/pages/countries/countries.component.ts");

    var CountriesModule = function CountriesModule() {
      _classCallCheck(this, CountriesModule);
    };

    CountriesModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineNgModule"]({
      type: CountriesModule
    });
    CountriesModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      factory: function CountriesModule_Factory(t) {
        return new (t || CountriesModule)();
      },
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_0__["CommonModule"], _countries_routing_module__WEBPACK_IMPORTED_MODULE_6__["CountriesRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["ReactiveFormsModule"], _angular_material_table__WEBPACK_IMPORTED_MODULE_4__["MatTableModule"], _angular_material_sort__WEBPACK_IMPORTED_MODULE_3__["MatSortModule"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_5__["NgbPaginationModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](CountriesModule, {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](CountriesModule, [{
...
//# sourceMappingURL=pages-countries-countries-module-es5.js.map