...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ConvertedType", function() { return ConvertedType; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "isConvertedTypeValid", function() { return isConvertedTypeValid; });
var ConvertedType;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CASHOUT_REQUEST_AMOUNT", function() { return CASHOUT_REQUEST_AMOUNT; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DATE_FORMAT", function() { return DATE_FORMAT; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FAILED_TO_RETRIEVE", function() { return FAILED_TO_RETRIEVE; });
/* harmony import */ var _user_role_enum__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./user-role.enum */ "./src/app/core/constants/user-role.enum.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "UserRole", function() { return _user_role_enum__WEBPACK_IMPORTED_MODULE_0__["UserRole"]; });

/* harmony import */ var _user_status_enum__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./user-status.enum */ "./src/app/core/constants/user-status.enum.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "UserStatus", function() { return _user_status_enum__WEBPACK_IMPORTED_MODULE_1__["UserStatus"]; });

/* harmony import */ var _transaction_type_enum__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./transaction-type.enum */ "./src/app/core/constants/transaction-type.enum.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "TransactionType", function() { return _transaction_type_enum__WEBPACK_IMPORTED_MODULE_2__["TransactionType"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "isTransactionTypeValid", function() { return _transaction_type_enum__WEBPACK_IMPORTED_MODULE_2__["isTransactionTypeValid"]; });

/* harmony import */ var _chart_name_enum__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./chart-name.enum */ "./src/app/core/constants/chart-name.enum.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "ChartName", function() { return _chart_name_enum__WEBPACK_IMPORTED_MODULE_3__["ChartName"]; });

/* harmony import */ var _converted_type_enum__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./converted-type.enum */ "./src/app/core/constants/converted-type.enum.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "ConvertedType", function() { return _converted_type_enum__WEBPACK_IMPORTED_MODULE_4__["ConvertedType"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "isConvertedTypeValid", function() { return _converted_type_enum__WEBPACK_IMPORTED_MODULE_4__["isConvertedTypeValid"]; });
...
const CASHOUT_REQUEST_AMOUNT = 'cashout-request-amount';
const DATE_FORMAT = 'YYYY-MM-DD';
const FAILED_TO_RETRIEVE = '-';
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "isTransactionTypeValid", function() { return isTransactionTypeValid; });
var TransactionType;
...
/* harmony import */ var src_app_shared_constants_api__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! src/app/shared/constants/api */ "./src/app/shared/constants/api/index.ts");
...
CreditsService.ɵfac = function CreditsService_Factory(t) { return new (t || CreditsService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_api_service__WEBPACK_IMPORTED_MODULE_2__["ApiService"])); };
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PaypalDirective", function() { return PaypalDirective; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var src_environments_environment__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! src/environments/environment */ "./src/environments/environment.ts");



class PaypalDirective {
    constructor(el) {
...
PaypalDirective.ɵfac = function PaypalDirective_Factory(t) { return new (t || PaypalDirective)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"])); };
PaypalDirective.ɵdir = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineDirective"]({ type: PaypalDirective, selectors: [["", "duelitPaypal", ""]], hostBindings: function PaypalDirective_HostBindings(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function PaypalDirective_click_HostBindingHandler($event) { return ctx.onClicked($event); });
    } }, outputs: { opened: "opened" } });
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](PaypalDirective, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Directive"],
        args: [{
                selector: '[duelitPaypal]'
            }]
    }], function () { return [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"] }]; }, { opened: [{
...
/* harmony import */ var _guards_redeem_guard__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @guards/redeem.guard */ "./src/app/guards/redeem.guard.ts");
/* harmony import */ var _redeem_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./redeem.component */ "./src/app/features/redeem/redeem.component.ts");
...
const routes = [{ path: '', component: _redeem_component__WEBPACK_IMPORTED_MODULE_3__["RedeemComponent"], canActivate: [_guards_redeem_guard__WEBPACK_IMPORTED_MODULE_2__["RedeemGuard"]] }];
class RedeemRoutingModule {
}
RedeemRoutingModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({ type: RedeemRoutingModule });
RedeemRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({ factory: function RedeemRoutingModule_Factory(t) { return new (t || RedeemRoutingModule)(); }, imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild(routes)],
        _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](RedeemRoutingModule, { imports: [_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"]], exports: [_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"]] }); })();
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](RedeemRoutingModule, [{
...
/* harmony import */ var _core_constants__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @core/constants */ "./src/app/core/constants/index.ts");
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/_esm2015/operators/index.js");
/* harmony import */ var src_app_core_services_credits_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/core/services/credits.service */ "./src/app/core/services/credits.service.ts");
...
/* harmony import */ var _directives_paypal_directive__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./directives/paypal.directive */ "./src/app/features/redeem/directives/paypal.directive.ts");
...
function RedeemComponent_ng_container_2_span_11_Template(rf, ctx) { if (rf & 1) {
...
function RedeemComponent_ng_container_2_div_23_Template(rf, ctx) { if (rf & 1) {
    ...
    const credits_r60 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;
...
function RedeemComponent_ng_container_2_ng_template_24_div_0_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "div", 13);
} }
function RedeemComponent_ng_container_2_ng_template_24_Template(rf, ctx) { if (rf & 1) {
...
function RedeemComponent_ng_container_2_Template(rf, ctx) { if (rf & 1) {
    ...
    const credits_r60 = ctx.$implicit;
    const _r63 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](25);
...
function RedeemComponent_ng_template_4_Template(rf, ctx) { if (rf & 1) {
...
class RedeemComponent {
    constructor(creditsService, fb) {
        this.creditsService = creditsService;
        this.fb = fb;
    }
    ngOnInit() {
        this.credits$ = this.creditsService.getCredits().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(credits => {
            this.credits = credits;
            this.cashOutForm = this.fb.group({
                cashOutAmount: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](0, [
                    _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].max(this.maxReemableDollars(credits.virtualAmount, credits.coinsRateConversion)),
                    _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].pattern(/^[0-9]*$/)
                ])
            });
            this.cashOutForm.get('cashOutAmount').valueChanges.subscribe(value => localStorage.setItem(_core_constants__WEBPACK_IMPORTED_MODULE_2__["CASHOUT_REQUEST_AMOUNT"], value));
    ...
    maxReemableDollars(coins, coinsRateConversion) {
...
RedeemComponent.ɵfac = function RedeemComponent_Factory(t) { return new (t || RedeemComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_core_services_credits_service__WEBPACK_IMPORTED_MODULE_4__["CreditsService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"])); };
RedeemComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: RedeemComponent, selectors: [["duelit-redeem"]], decls: 7, vars: 4, consts: [[1, "flex-grow"], [1, "flex-align-center"], [4, "ngIf", "ngIfElse"], ["loading", ""], ["head", "Cash Out Request"], [1, "form-group", 3, "formGroup"], ["type", "number", "formControlName", "cashOutAmount", "step", "1", "min", "0", 1, "form-control", "custom", 3, "max"], [4, "ngIf"], [1, "cash"], ["class", "error flex-align-center", 4, "ngIf", "ngIfElse"], ["paypal", ""], [1, "error", "flex-align-center"], ["duelitPaypal", "", 4, "ngIf"], ["duelitPaypal", ""]], template: function RedeemComponent_Template(rf, ctx) { if (rf & 1) {
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](RedeemComponent, [{
    ...
    }], function () { return [{ type: src_app_core_services_credits_service__WEBPACK_IMPORTED_MODULE_4__["CreditsService"] }, { type: _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"] }]; }, null); })();
...
/* harmony import */ var _redeem_routing_module__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./redeem-routing.module */ "./src/app/features/redeem/redeem-routing.module.ts");
/* harmony import */ var _redeem_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./redeem.component */ "./src/app/features/redeem/redeem.component.ts");
/* harmony import */ var _directives_paypal_directive__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./directives/paypal.directive */ "./src/app/features/redeem/directives/paypal.directive.ts");
...
RedeemModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineNgModule"]({ type: RedeemModule });
RedeemModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({ factory: function RedeemModule_Factory(t) { return new (t || RedeemModule)(); }, imports: [[
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](RedeemModule, { declarations: [_redeem_component__WEBPACK_IMPORTED_MODULE_5__["RedeemComponent"], _directives_paypal_directive__WEBPACK_IMPORTED_MODULE_6__["PaypalDirective"]], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_0__["CommonModule"],
        _redeem_routing_module__WEBPACK_IMPORTED_MODULE_4__["RedeemRoutingModule"],
        _shared_components_panel__WEBPACK_IMPORTED_MODULE_3__["PanelModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_2__["ReactiveFormsModule"]] }); })();
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](RedeemModule, [{
...
//# sourceMappingURL=features-redeem-redeem-module-es2015.js.map