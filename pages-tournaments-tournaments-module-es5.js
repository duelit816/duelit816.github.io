...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-tournaments-tournaments-module"], {
  ...
  /***/
  function srcAppFeaturesAdminPagesTournamentsTournamentsRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "TournamentsRoutingModule", function () {
      return TournamentsRoutingModule;
    });
    /* harmony import */
    ...
    var _tournaments_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./tournaments.component */
    "./src/app/features/admin/pages/tournaments/tournaments.component.ts");

    var routes = [{
      path: '',
      component: _tournaments_component__WEBPACK_IMPORTED_MODULE_2__["TournamentsComponent"]
    }];

    var TournamentsRoutingModule = function TournamentsRoutingModule() {
      _classCallCheck(this, TournamentsRoutingModule);
    };

    TournamentsRoutingModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
      type: TournamentsRoutingModule
    });
    TournamentsRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      factory: function TournamentsRoutingModule_Factory(t) {
        return new (t || TournamentsRoutingModule)();
      },
      imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild(routes)], _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](TournamentsRoutingModule, {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](TournamentsRoutingModule, [{
  ...
  /***/
  function srcAppFeaturesAdminPagesTournamentsTournamentsComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _core_services_login_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    ...
    var _shared_components_panel_panel_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! ../../../../shared/components/panel/panel.component */
    "./src/app/shared/components/panel/panel.component.ts");
    /* harmony import */


    var _shared_components_date_time_picker_date_time_picker_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    /*! ../../../../shared/components/date-time-picker/date-time-picker.component */
    ...
    function TournamentsComponent_ng_container_14_option_1_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function TournamentsComponent_ng_container_14_Template(rf, ctx) {
      if (rf & 1) {
    ...
    /*#__PURE__*/
    function () {
      function TournamentsComponent(api, fb, loginService, toast) {
      ...
      _createClass(TournamentsComponent, [{
        ...
        key: "isCreateDisabled",
        value: function isCreateDisabled() {
        ...
        value: function createTournament() {
          ...
          var tournamentFormValue = this.tournamentForm.value;
          var dateTime = tournamentFormValue.dateTime;
          var tournamentDetails = {
            ...
            started_at: moment__WEBPACK_IMPORTED_MODULE_4__().year(dateTime.year).month(dateTime.month + 1).day(dateTime.day).hour(dateTime.hour).minute(dateTime.minute).utc().format('DD/MM/YYYY HH:mm:ss')
          };
          this.api.post(_shared_constants_api__WEBPACK_IMPORTED_MODULE_3__["TournamentsApi"].CreateTournament, {
            ...
            _this.toast.success('Tournament created successfully.');
          });
        }
      }]);
    ...
    TournamentsComponent.ɵfac = function TournamentsComponent_Factory(t) {
      return new (t || TournamentsComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_core_services_api_service__WEBPACK_IMPORTED_MODULE_7__["ApiService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_core_services_login_service__WEBPACK_IMPORTED_MODULE_8__["LoginService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_core_services_toast_service__WEBPACK_IMPORTED_MODULE_9__["ToastService"]));
    };

    TournamentsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: TournamentsComponent,
      selectors: [["duelit-tournaments"]],
      decls: 23,
      vars: 7,
      consts: [["head", "Create a tournament"], [1, "row", 3, "formGroup"], [1, "date-time", "col-md"], ["formControlName", "dateTime", 3, "minDate"], [1, "game-details", "col-md"], [1, "form-group"], ["formControlName", "status", "formControlName", "game", 1, "form-control"], [3, "value"], [4, "ngIf"], ["type", "number", "min", "2", "formControlName", "playerCount", 1, "form-control"], [1, "btn", "custom", "primary", 3, "disabled", "click"], [3, "value", 4, "ngFor", "ngForOf"]],
      template: function TournamentsComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function TournamentsComponent_Template_button_click_21_listener() {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](TournamentsComponent, [{
        ...
        return [{
          ...
          type: _core_services_login_service__WEBPACK_IMPORTED_MODULE_8__["LoginService"]
        }, {
  ...
  /***/
  function srcAppFeaturesAdminPagesTournamentsTournamentsModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "TournamentsModule", function () {
    ...
    var _shared_components_date_time_picker_date_time_picker_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! @shared/components/date-time-picker/date-time-picker.module */
    "./src/app/shared/components/date-time-picker/date-time-picker.module.ts");
    /* harmony import */


    var _shared_components_panel__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! @shared/components/panel */
    "./src/app/shared/components/panel/index.ts");
    /* harmony import */


    var _tournaments_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./tournaments-routing.module */
    "./src/app/features/admin/pages/tournaments/tournaments-routing.module.ts");
    /* harmony import */


    var _tournaments_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./tournaments.component */
    "./src/app/features/admin/pages/tournaments/tournaments.component.ts");

    var TournamentsModule = function TournamentsModule() {
      _classCallCheck(this, TournamentsModule);
    };

    TournamentsModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineNgModule"]({
      type: TournamentsModule
    });
    TournamentsModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      factory: function TournamentsModule_Factory(t) {
        return new (t || TournamentsModule)();
      },
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_0__["CommonModule"], _tournaments_routing_module__WEBPACK_IMPORTED_MODULE_5__["TournamentsRoutingModule"], _shared_components_panel__WEBPACK_IMPORTED_MODULE_4__["PanelModule"], _shared_components_date_time_picker_date_time_picker_module__WEBPACK_IMPORTED_MODULE_3__["DateTimePickerModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["ReactiveFormsModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](TournamentsModule, {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](TournamentsModule, [{
  ...
  /***/
  function srcAppSharedComponentsDateTimePickerDateTimePickerComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    /*#__PURE__*/
    function () {
      function DateTimePickerComponent(fb) {
      ...
      _createClass(DateTimePickerComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.dateTimeForm.valueChanges.subscribe(function (value) {
            _this2.onChange({
    ...
    DateTimePickerComponent.ɵfac = function DateTimePickerComponent_Factory(t) {
      return new (t || DateTimePickerComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"]));
    };

    DateTimePickerComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: DateTimePickerComponent,
      selectors: [["duelit-date-time-picker"]],
      inputs: {
        minDate: "minDate"
      },
      decls: 6,
      vars: 7,
      consts: [[3, "formGroup"], [3, "click"], ["formControlName", "time", 3, "meridian"], ["formControlName", "date", 3, "minDate"]],
      template: function DateTimePickerComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function DateTimePickerComponent_Template_button_click_2_listener() {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](DateTimePickerComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAppSharedComponentsDateTimePickerDateTimePickerModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _date_time_picker_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    ...
    DateTimePickerModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineNgModule"]({
      type: DateTimePickerModule
    });
    DateTimePickerModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      factory: function DateTimePickerModule_Factory(t) {
        return new (t || DateTimePickerModule)();
      },
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_0__["CommonModule"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_3__["NgbDatepickerModule"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_3__["NgbTimepickerModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["ReactiveFormsModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](DateTimePickerModule, {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](DateTimePickerModule, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"],
        args: [{
          declarations: [_date_time_picker_component__WEBPACK_IMPORTED_MODULE_4__["DateTimePickerComponent"]],
          imports: [_angular_common__WEBPACK_IMPORTED_MODULE_0__["CommonModule"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_3__["NgbDatepickerModule"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_3__["NgbTimepickerModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["ReactiveFormsModule"]],
...
//# sourceMappingURL=pages-tournaments-tournaments-module-es5.js.map