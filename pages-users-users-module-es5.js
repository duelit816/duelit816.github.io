...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-users-users-module"], {
  ...
  function node_modulesAngularMaterial__ivy_ngcc__Fesm2015ButtonJs(module, __webpack_exports__, __webpack_require__) {
    ...
    function (_MatButtonMixinBase2) {
      ...
      function MatButton(elementRef, _focusMonitor, _animationMode) {
        ...
        _this4 = _possibleConstructorReturn(this, _getPrototypeOf(MatButton).call(this, elementRef));
        ...
        _this4.isRoundButton = _this4._hasHostAttributes('mat-fab', 'mat-mini-fab');
        /**
         * Whether the button is icon button.
         */

        _this4.isIconButton = _this4._hasHostAttributes('mat-icon-button'); // For each of the variant selectors that is present in the button's host
        ...
        try {
          for (var _iterator = BUTTON_HOST_ATTRIBUTES[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            ...
            if (_this4._hasHostAttributes(attr)) {
              /** @type {?} */
              _this4._getHostElement().classList.add(attr);
            }
        ...
        _this4._focusMonitor.monitor(_this4._elementRef, true);

        if (_this4.isRoundButton) {
          _this4.color = DEFAULT_ROUND_BUTTON_COLOR;
        }
      ...
      _createClass(MatButton, [{
        ...
        value: function _hasHostAttributes() {
          ...
          */
          function (attribute) {
            return _this5._getHostElement().hasAttribute(attribute);
          });
        }
      }]);
  ...
  function node_modulesAngularMaterial__ivy_ngcc__Fesm2015FormFieldJs(module, __webpack_exports__, __webpack_require__) {
    ...
    function (_MatFormFieldMixinBas) {
      ...
      function MatFormField(_elementRef, _changeDetectorRef, labelOptions, _dir, _defaults, _platform, _ngZone, _animationMode) {
        ...
        _this6 = _possibleConstructorReturn(this, _getPrototypeOf(MatFormField).call(this, _elementRef));
      ...
      _createClass(MatFormField, [{
        ...
        value: function updateOutlineGap() {
          ...
          if (this._label && this._label.nativeElement.children.length) {
            ...
            try {
              for (var _iterator2 = labelEl.children[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
  ...
  function node_modulesAngularMaterial__ivy_ngcc__Fesm2015PaginatorJs(module, __webpack_exports__, __webpack_require__) {
    ...
    function (_MatPaginatorBase2) {
      ...
      function MatPaginator(_intl, _changeDetectorRef, defaults) {
        ...
        _this10 = _possibleConstructorReturn(this, _getPrototypeOf(MatPaginator).call(this));
        _this10._intl = _intl;
        ...
        _this10._intlChanges = _intl.changes.subscribe(
        /**
        * @return {?}
        */
        function () {
  ...
  function node_modulesAngularMaterial__ivy_ngcc__Fesm2015SelectJs(module, __webpack_exports__, __webpack_require__) {
    ...
    function (_MatSelectMixinBase2) {
      ...
      function MatSelect(_viewportRuler, _changeDetectorRef, _ngZone, _defaultErrorStateMatcher, elementRef, _dir, _parentForm, _parentFormGroup, _parentFormField, ngControl, tabIndex, scrollStrategyFactory, _liveAnnouncer, defaults) {
        ...
        _this11 = _possibleConstructorReturn(this, _getPrototypeOf(MatSelect).call(this, elementRef, _defaultErrorStateMatcher, _parentForm, _parentFormGroup, ngControl));
        _this11._viewportRuler = _viewportRuler;
        _this11._changeDetectorRef = _changeDetectorRef;
        _this11._ngZone = _ngZone;
        _this11._dir = _dir;
        _this11._parentFormField = _parentFormField;
        _this11.ngControl = ngControl;
        _this11._liveAnnouncer = _liveAnnouncer;
        /**
         * Whether or not the overlay panel is open.
         */

        _this11._panelOpen = false;
        /**
        ...
        _this11._multiple = false;
        /**
         * Comparison function to specify which option is displayed. Defaults to object equality.
         */

        _this11._compareWith =
        /**
        * @param {?} o1
        * @param {?} o2
        * @return {?}
        */
        ...
        _this11._uid = "mat-select-".concat(nextUniqueId++);
        /**
         * Emits whenever the component is destroyed.
         */

        _this11._destroy = new rxjs__WEBPACK_IMPORTED_MODULE_12__["Subject"]();
        /**
        ...
        */
        ...
        _this11._panelDoneAnimatingStream = new rxjs__WEBPACK_IMPORTED_MODULE_12__["Subject"]();
        /**
        ...
        _this11._disableOptionCentering = false;
        _this11._focused = false;
        /**
         * A name for this control that can be used by `mat-form-field`.
         */

        _this11.controlType = 'mat-select';
        /**
        ...
        _this11.optionSelectionChanges =
        /** @type {?} */
        ...
        */
        function () {
          ...
          return _this11._ngZone.onStable.asObservable().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_13__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_13__["switchMap"])(
          /**
          * @return {?}
          */
          function () {
            return _this11.optionSelectionChanges;
          }));
        });
        /**
        ...
        _this11.openedChange = new _angular_core__WEBPACK_IMPORTED_MODULE_2__["EventEmitter"]();
        /**
         * Event emitted when the select has been opened.
         */

        _this11._openedStream = _this11.openedChange.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_13__["filter"])(
        /**
        * @param {?} o
        * @return {?}
        */
        ...
        */
        ...
        _this11._closedStream = _this11.openedChange.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_13__["filter"])(
        /**
        * @param {?} o
        * @return {?}
        */
        ...
        */
        ...
        _this11.selectionChange = new _angular_core__WEBPACK_IMPORTED_MODULE_2__["EventEmitter"]();
        /**
        ...
        _this11.valueChange = new _angular_core__WEBPACK_IMPORTED_MODULE_2__["EventEmitter"]();

        if (_this11.ngControl) {
          // Note: we provide the value accessor through here, instead of
          // the `providers` to avoid running into a circular import.
          _this11.ngControl.valueAccessor = _assertThisInitialized(_this11);
        }

        _this11._scrollStrategyFactory = scrollStrategyFactory;
        _this11._scrollStrategy = _this11._scrollStrategyFactory();
        _this11.tabIndex = parseInt(tabIndex) || 0; // Force setter to be called in case id was not specified.

        _this11.id = _this11.id;

        if (defaults) {
          if (defaults.disableOptionCentering != null) {
            _this11.disableOptionCentering = defaults.disableOptionCentering;
          }

          if (defaults.typeaheadDebounceInterval != null) {
            _this11.typeaheadDebounceInterval = defaults.typeaheadDebounceInterval;
          }
        }
      ...
      _createClass(MatSelect, [{
          ...
          */
          function () {
            if (_this12.panelOpen) {
              ...
              _this12.openedChange.emit(true);
            } else {
              _this12.openedChange.emit(false);

              _this12.overlayDir.offsetX = 0;
        ...
        value: function ngAfterContentInit() {
          ...
          */
          function () {
            _this13._resetOptions();

            _this13._initializeSelection();
          });
        }
        /**
         * @return {?}
        ...
        value: function open() {
          ...
          */
          function () {
            if (_this14._triggerFontSize && _this14.overlayDir.overlayRef && _this14.overlayDir.overlayRef.overlayElement) {
              _this14.overlayDir.overlayRef.overlayElement.style.fontSize = "".concat(_this14._triggerFontSize, "px");
            }
          });
        }
        /**
        ...
        value: function _onAttached() {
          ...
          */
          function () {
            ...
            _this15._calculateOverlayOffsetX();

            _this15.panel.nativeElement.scrollTop = _this15._scrollTop;
          });
        }
        /**
        ...
        value: function _initializeSelection() {
          ...
          */
          function () {
            _this16._setSelectionByValue(_this16.ngControl ? _this16.ngControl.value : _this16._value);
          ...
          if (this.multiple && value) {
            ...
            */
            function (currentValue) {
              return _this17._selectValue(currentValue);
            });
          ...
          */
          function (option) {
            try {
              ...
              return option.value != null && _this18._compareWith(option.value, value);
            } catch (error) {
        ...
        value: function _initKeyManager() {
          ...
          */
          function () {
            ...
            if (!_this19.multiple && _this19._keyManager.activeItem) {
              _this19._keyManager.activeItem._selectViaInteraction();
          ...
          */
          function () {
            if (_this19._panelOpen && _this19.panel) {
              _this19._scrollActiveOptionIntoView();
            } else if (!_this19._panelOpen && !_this19.multiple && _this19._keyManager.activeItem) {
              _this19._keyManager.activeItem._selectViaInteraction();
            }
          });
        }
        ...
        value: function _resetOptions() {
          ...
          */
          function (event) {
            _this20._onSelect(event.source, event.isUserInput);

            if (event.isUserInput && !_this20.multiple && _this20._panelOpen) {
              _this20.close();
        ...
        value: function _sortValues() {
          ...
          if (this.multiple) {
            ...
            */
            function (a, b) {
              return _this21.sortComparator ? _this21.sortComparator(a, b, options) : options.indexOf(a) - options.indexOf(b);
            });
  ...
  function node_modulesAngularMaterial__ivy_ngcc__Fesm2015TooltipJs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _hammerLoader) {
        ...
        */
        function (event) {
          if (_this22._isTooltipVisible() && event.keyCode === _angular_cdk_keycodes__WEBPACK_IMPORTED_MODULE_7__["ESCAPE"] && !Object(_angular_cdk_keycodes__WEBPACK_IMPORTED_MODULE_7__["hasModifierKey"])(event)) {
            event.preventDefault();
        ...
        */
        function () {
          _elementRef.nativeElement.addEventListener('keydown', _this22._handleKeydown);
        });
      }
      /**
      ...
      _createClass(MatTooltip, [{
        ...
        value: function _createOverlay() {
          ...
          */
          function (change) {
            if (_this24._tooltipInstance) {
              if (change.scrollableViewProperties.isOverlayClipped && _this24._tooltipInstance.isVisible()) {
            ...
            */
            function () {
              if (_this25._tooltipInstance) {
                /** @type {?} */
                _this25._overlayRef.updatePosition();
              }
            });
          }
        }
        ...
        value: function _setupPointerEvents() {
          ...
          if (!this._platform.IOS && !this._platform.ANDROID) {
            ...
            */
            function touchendListener() {
              clearTimeout(_this26._touchstartTimeout);

              _this26.hide(_this26._defaultOptions.touchendHideDelay);
            };
            ...
            */
            function () {
              ...
              clearTimeout(_this26._touchstartTimeout);
              _this26._touchstartTimeout = setTimeout(
              /**
              * @return {?}
              */
              function () {
          ...
          */
          function (listener, event) {
            _this26._elementRef.nativeElement.addEventListener(event, listener, passiveListenerOptions);
          });
        }
        /**
          ...
          if (!this._message && this._isTooltipVisible()) {
            ...
            */
            function () {
              ...
              */
              function () {
                _this27._ariaDescriber.describe(_this27._elementRef.nativeElement, _this27.message);
              });
            });
          }
        }
    ...
    function () {
      ...
      _createClass(TooltipComponent, [{
        ...
        value: function show(delay) {
          ...
          */
          function () {
            _this28._visibility = 'visible';
            _this28._showTimeoutId = null; // Mark for check so if any parent component has set the
        ...
        value: function hide(delay) {
          ...
          */
          function () {
            _this29._visibility = 'hidden';
            _this29._hideTimeoutId = null; // Mark for check so if any parent component has set the
            // ChangeDetectionStrategy to OnPush it will be checked anyways

            _this29._markForCheck();
          }, delay);
        }
        /**
  ...
  /***/
  function srcAppFeaturesAdminPagesUsersUsersRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppFeaturesAdminPagesUsersUsersComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _shared_constants_api__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! @shared/constants/api */
    "./src/app/shared/constants/api/index.ts");
    /* harmony import */


    var _shared_functions_date_util__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    ...
    var _services_users_date_service__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
    /*! ../../services/users-date.service */
    "./src/app/features/admin/services/users-date.service.ts");
    /* harmony import */


    var _shared_components_date_picker_range_date_picker_range_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
    ...
    function UsersComponent_td_12_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"](" ", element_r321.firstName, " ");
      }
    }
    ...
    function UsersComponent_td_15_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"](" ", element_r322.lastName, " ");
      }
    }
    ...
    function UsersComponent_td_18_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"](" ", element_r323.email, " ");
      }
    }
    ...
    function UsersComponent_td_21_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"](" ", element_r324.country, " ");
      }
    }
    ...
    function UsersComponent_td_24_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"](" ", element_r325.status, " ");
      }
    }
    ...
    function UsersComponent_td_27_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](2, "fa-icon", 33);
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function UsersComponent_td_27_Template_button_click_4_listener() {
          ...
          return ctx_r327.openUserProfile(element_r326);
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function UsersComponent_td_27_Template_button_click_6_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r328);
          ...
          return ctx_r329.openUserStats(element_r326);
        });

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](7, "View Stats");
      ...
      if (rf & 2) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("icon", ctx_r311.actionIcon);
      }
    }
    ...
    function UsersComponent_th_37_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](7, "Inactive");

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](8, "option", 45);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](9, "Deactivated");

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](10, "option", 46);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](11, "Pending");

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](12, "option", 47);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](13, "Banned");
    ...
    function UsersComponent_tr_42_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var _c0 = function _c0() {
      return ["firstName-search", "lastName-search", "email-search", "country-search", "status-filter", "action-col-filler"];
    };

    var UsersComponent =
    /*#__PURE__*/
    function () {
      function UsersComponent(api, fb, route, router, calendar, usersDate) {
        ...
        this.displayedColumns = ['firstName', 'lastName', 'email', 'country', 'status', 'action'];
        this.dataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_2__["MatTableDataSource"]([]);
        this.actionIcon = _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_4__["faEllipsisV"];
        this.totalCount = 0;
        this.isLoading = true;
        this.sortDirection$ = new rxjs__WEBPACK_IMPORTED_MODULE_8__["BehaviorSubject"]({
          active: 'firstName',
          direction: 'desc'
        });
      ...
      _createClass(UsersComponent, [{
        ...
        value: function ngOnInit() {
          ...
          var initialPage = 1;
          this.page$ = new rxjs__WEBPACK_IMPORTED_MODULE_8__["BehaviorSubject"](initialPage);
          this.date$ = new rxjs__WEBPACK_IMPORTED_MODULE_8__["BehaviorSubject"](this.usersDate.range);
          this.rangeDate = new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](this.usersDate.range);
          this.rangeDate.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["takeUntil"])(this.ngUnsubscribe)).subscribe(function (value) {
            _this30.usersDate.range = value;
          });
          this.setQueryDate();
          this.filterFormGroup = this.fb.group({
            ...
            status: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](this.getInitialStatus())
          });
          this.updateDate();
          this.dataSource$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_8__["combineLatest"])([this.page$, this.sortDirection$, this.filterFormGroup.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["startWith"])(this.filterFormGroup.value)), this.date$]).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["distinctUntilChanged"])(), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["tap"])(function () {
            return _this30.isLoading = true;
          }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["debounceTime"])(500), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["switchMap"])(function (_ref) {
            ...
            var convertedType = _this30.route.snapshot.queryParams.convertedType;
            var transactionType = _this30.route.snapshot.queryParams.transaction;
            var path;

            if (Object(_core_constants__WEBPACK_IMPORTED_MODULE_3__["isConvertedTypeValid"])(convertedType)) {
              path = _this30.api.buildPath(_shared_constants_api__WEBPACK_IMPORTED_MODULE_5__["UsersApi"].UsersByConverted, [convertedType]);
            } else if (Object(_core_constants__WEBPACK_IMPORTED_MODULE_3__["isTransactionTypeValid"])(transactionType)) {
              path = _this30.api.buildPath(_shared_constants_api__WEBPACK_IMPORTED_MODULE_5__["UsersApi"].UsersByTransaction, [transactionType]);
            } else {
              path = _this30.api.buildPath(_shared_constants_api__WEBPACK_IMPORTED_MODULE_5__["UsersApi"].UsersByStatus, filter.status ? [filter.status] : ['']);
            }

            var startDate = Object(_shared_functions_date_util__WEBPACK_IMPORTED_MODULE_6__["ngbDateToMoment"])(date.from).format(_core_constants__WEBPACK_IMPORTED_MODULE_3__["DATE_FORMAT"]);
            var endDate = Object(_shared_functions_date_util__WEBPACK_IMPORTED_MODULE_6__["ngbDateToMoment"])(date.to).format(_core_constants__WEBPACK_IMPORTED_MODULE_3__["DATE_FORMAT"]);
            var createdStartDate = _this30.route.snapshot.queryParams.created_start_date;
            var createdEndDate = _this30.route.snapshot.queryParams.created_end_date;
            var lastActiveStartDate = _this30.route.snapshot.queryParams.last_active_start_date;
            var lastActiveEndDate = _this30.route.snapshot.queryParams.last_active_end_date;
            var notStatus = _this30.route.snapshot.queryParams.not_status;
            var amount = _this30.route.snapshot.queryParams.amount;
            var query = {
              page: page - 1,
              limit: 10,
            ...
            return _this30.api.get(path, {
              query: query
            }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["catchError"])(function (err) {
              return Object(rxjs__WEBPACK_IMPORTED_MODULE_8__["of"])({
                totalCount: 0,
                results: []
              });
            }));
          }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["tap"])(function (results) {
            _this30.totalCount = results.totalCount;
            _this30.isLoading = false;
          }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["map"])(function (results) {
            return results.results;
          }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["takeUntil"])(this.ngUnsubscribe));
        }
      }, {
        key: "ngOnDestroy",
        value: function ngOnDestroy() {
        ...
        value: function getInitialStatus() {
          var paramStatus = this.route.snapshot.queryParams.status;

          switch (paramStatus) {
            case _core_constants__WEBPACK_IMPORTED_MODULE_3__["UserStatus"].Active:
            case _core_constants__WEBPACK_IMPORTED_MODULE_3__["UserStatus"].Deactived:
            case _core_constants__WEBPACK_IMPORTED_MODULE_3__["UserStatus"].Inactive:
            case _core_constants__WEBPACK_IMPORTED_MODULE_3__["UserStatus"].Pending:
            case _core_constants__WEBPACK_IMPORTED_MODULE_3__["UserStatus"].Banned:
              return paramStatus;
        ...
        value: function updateDate() {
          this.date$.next(Object.assign({}, this.rangeDate.value));
        }
      }, {
        ...
        key: "momentToNgbDate",
        value: function momentToNgbDate(momentDate) {
          var calendar = this.calendar.getToday();
        ...
        key: "setQueryDate",
        value: function setQueryDate() {
          if (this.route.snapshot.queryParams.start_date && this.route.snapshot.queryParams.end_date) {
            var startDate = moment__WEBPACK_IMPORTED_MODULE_7__(this.route.snapshot.queryParams.start_date);
            var endDate = moment__WEBPACK_IMPORTED_MODULE_7__(this.route.snapshot.queryParams.end_date);
        ...
        key: "openUserProfile",
        value: function openUserProfile(user) {
          this.router.navigate(["/admin/user", user.id]);
        }
      }, {
        key: "openUserStats",
        value: function openUserStats(user) {
    ...
    UsersComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function UsersComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](5, "Last updated");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](6, "duelit-date-picker-range", 2);
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("matSortChange", function UsersComponent_Template_table_matSortChange_9_listener($event) {
            return ctx.sortData($event);
          });

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](10, 5);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](11, UsersComponent_th_11_Template, 2, 0, "th", 6);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](12, UsersComponent_td_12_Template, 2, 1, "td", 7);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](13, 8);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](14, UsersComponent_th_14_Template, 2, 0, "th", 6);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](15, UsersComponent_td_15_Template, 2, 1, "td", 7);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](16, 9);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](17, UsersComponent_th_17_Template, 2, 0, "th", 6);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](18, UsersComponent_td_18_Template, 2, 1, "td", 7);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](19, 10);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](20, UsersComponent_th_20_Template, 2, 0, "th", 6);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](21, UsersComponent_td_21_Template, 2, 1, "td", 7);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](22, 11);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](23, UsersComponent_th_23_Template, 2, 0, "th", 12);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](24, UsersComponent_td_24_Template, 2, 1, "td", 7);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](25, 13);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](26, UsersComponent_th_26_Template, 1, 0, "th", 14);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](27, UsersComponent_td_27_Template, 8, 1, "td", 15);
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](31, UsersComponent_th_31_Template, 2, 0, "th", 17);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](32, 19);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](33, UsersComponent_th_33_Template, 2, 0, "th", 17);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](34, 20);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](35, UsersComponent_th_35_Template, 2, 0, "th", 17);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](36, 21);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](37, UsersComponent_th_37_Template, 14, 1, "th", 17);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](38, 22);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](39, UsersComponent_th_39_Template, 1, 0, "th", 14);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](40, UsersComponent_tr_40_Template, 1, 0, "tr", 23);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](41, UsersComponent_tr_41_Template, 1, 0, "tr", 24);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](42, UsersComponent_tr_42_Template, 1, 0, "tr", 25);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](43, "ngb-pagination", 26);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("pageChange", function UsersComponent_Template_ngb_pagination_pageChange_43_listener($event) {
        ...
        if (rf & 2) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"](" Total Results: ", ctx.getTotalCount(), " ");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("dataSource", ctx.dataSource$)("formGroup", ctx.filterFormGroup);
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("matHeaderRowDef", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpureFunction0"](19, _c0))("matHeaderRowDefSticky", true);
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](UsersComponent, [{
        ...
        return [{
          ...
          type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_12__["NgbCalendar"]
        }, {
          type: _services_users_date_service__WEBPACK_IMPORTED_MODULE_13__["UsersDateService"]
        }];
      }, null);
    })();
    /***/
  ...
  /***/
  "./src/app/features/admin/pages/users/users.module.ts":
  /*!************************************************************!*\
    !*** ./src/app/features/admin/pages/users/users.module.ts ***!
    \************************************************************/
  ...
  /***/
  function srcAppFeaturesAdminPagesUsersUsersModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _shared_components_date_picker_range_date_picker_range_module__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    ...
    var _users_routing_module__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    ...
    UsersModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineNgModule"]({
      type: UsersModule
    });
    UsersModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      factory: function UsersModule_Factory(t) {
        return new (t || UsersModule)();
      },
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_0__["CommonModule"], _users_routing_module__WEBPACK_IMPORTED_MODULE_10__["UsersRoutingModule"], _angular_material_table__WEBPACK_IMPORTED_MODULE_6__["MatTableModule"], _fortawesome_angular_fontawesome__WEBPACK_IMPORTED_MODULE_7__["FontAwesomeModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_3__["MatButtonModule"], _angular_material_sort__WEBPACK_IMPORTED_MODULE_5__["MatSortModule"], _angular_material_paginator__WEBPACK_IMPORTED_MODULE_4__["MatPaginatorModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["ReactiveFormsModule"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_8__["NgbDropdownModule"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_8__["NgbPaginationModule"], _shared_components_date_picker_range_date_picker_range_module__WEBPACK_IMPORTED_MODULE_9__["DatePickerRangeModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](UsersModule, {
        declarations: [_users_component__WEBPACK_IMPORTED_MODULE_11__["UsersComponent"]],
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_0__["CommonModule"], _users_routing_module__WEBPACK_IMPORTED_MODULE_10__["UsersRoutingModule"], _angular_material_table__WEBPACK_IMPORTED_MODULE_6__["MatTableModule"], _fortawesome_angular_fontawesome__WEBPACK_IMPORTED_MODULE_7__["FontAwesomeModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_3__["MatButtonModule"], _angular_material_sort__WEBPACK_IMPORTED_MODULE_5__["MatSortModule"], _angular_material_paginator__WEBPACK_IMPORTED_MODULE_4__["MatPaginatorModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["ReactiveFormsModule"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_8__["NgbDropdownModule"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_8__["NgbPaginationModule"], _shared_components_date_picker_range_date_picker_range_module__WEBPACK_IMPORTED_MODULE_9__["DatePickerRangeModule"]]
      });
    })();
    /*@__PURE__*/
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](UsersModule, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"],
        args: [{
          declarations: [_users_component__WEBPACK_IMPORTED_MODULE_11__["UsersComponent"]],
          imports: [_angular_common__WEBPACK_IMPORTED_MODULE_0__["CommonModule"], _users_routing_module__WEBPACK_IMPORTED_MODULE_10__["UsersRoutingModule"], _angular_material_table__WEBPACK_IMPORTED_MODULE_6__["MatTableModule"], _fortawesome_angular_fontawesome__WEBPACK_IMPORTED_MODULE_7__["FontAwesomeModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_3__["MatButtonModule"], _angular_material_sort__WEBPACK_IMPORTED_MODULE_5__["MatSortModule"], _angular_material_paginator__WEBPACK_IMPORTED_MODULE_4__["MatPaginatorModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["ReactiveFormsModule"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_8__["NgbDropdownModule"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_8__["NgbPaginationModule"], _shared_components_date_picker_range_date_picker_range_module__WEBPACK_IMPORTED_MODULE_9__["DatePickerRangeModule"]]
